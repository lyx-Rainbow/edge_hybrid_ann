...
class Index(ABC):
    ...
    def flush(self) -> None:
        """Finalize the index after building.

        Called once after all vectors have been inserted and access granted.
        For Curator, this writes raw vectors to flash and frees the in-memory
        buffer. For other indexes, this is a no-op.
        """
        return
